...
$sql = "insert into usuarios(login_user,nombre_user,tel_user,mail_user,cod_puesto,cod_perf,cod_estado) values('$login_user','$nombre_user','$tel_user','$mail_user','$cod_puesto','$cod_perf','$cod_estado')";
